---
title: Installation
description: Learn how to install, configure, and launch ItsMyBot based on your preferred hosting method.
icon: Rocket
---

import { Step, Steps } from 'fumadocs-ui/components/steps';

To install ItsMyBot, you can follow the steps below. The installation process may vary depending on your hosting method, but the general steps are as follows:
...
<Cards>
<Card icon={<CloudIcon className="text-fd-primary" />} title='Hosting Provider' href='/docs/itsmybot/installation/hosting-provider'>

Use an external bot hosting service. No server management required, perfect for beginners. Recommended

</Card>

<Card icon={<PanelsTopLeftIcon className="text-fd-primary" />} title='Self-Hosted Panel'  href='/docs/itsmybot/installation/self-hosted-panel'>

Manage the bot using your own instance of Pterodactyl. Great for configuring it easily. Recommended

</Card>

<Card icon={<ServerIcon className="text-fd-primary" />} title='VPS Setup'  href='/docs/itsmybot/installation/vps'>

Install the bot on your own Linux VPS using Node.js and PM2. Need to be comfortable with command line and server management.
