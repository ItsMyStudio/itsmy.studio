...
<Cards>
<Card icon={<CloudIcon />} title='Hosting Provider' href='/docs/itsmybot/installation/hosting-provider'>

Use an external bot hosting service. No server management required, perfect for beginners. Recommended

</Card>

<Card icon={<PanelsTopLeftIcon />} title='Self-Hosted Panel'  href='/docs/itsmybot/installation/self-hosted-panel'>

Manage the bot using your own instance of Pterodactyl. Great for configuring it easily. Recommended

</Card>

<Card icon={<ServerIcon />} title='VPS Setup'  href='/docs/itsmybot/installation/vps'>
