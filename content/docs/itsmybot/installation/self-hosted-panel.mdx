...
description: Learn how to quickly set up ItsMyBot using your own Pterodactyl or Pelican panel.
---
...
5. You can now go back to the user panel of Pterodactyl, select the server you just created and follow the [Hosting Provider](/docs/itsmybot/installation/hosting-provider) guide to run the bot.
