---
title: VPS
description: Learn how to quickly set up ItsMyBot on a Virtual Private Server (VPS) and run it continuously.
---
...
8. You can then proceed to [configure the bot](/docs/itsmybot/installation#create-the-bot-on-discord) on Discord.
