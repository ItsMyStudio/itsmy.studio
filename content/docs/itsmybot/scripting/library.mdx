---
title: Library
description: Browse reusable ItsMyBot scripts, actions, conditions, and triggers shared by the community. Find inspiration for your own customizations or easily copy and paste snippets into your server.
icon: "Package"
---
